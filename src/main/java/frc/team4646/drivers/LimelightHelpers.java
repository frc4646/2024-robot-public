...
public class LimelightHelpers
{
    ...
    public static class PoseEstimate
    {
        ...
        public int tagCount;
        public double tagSpanM;
        public double avgTagDistM;
        ...
        public PoseEstimate(Pose2d pose, double timestampSeconds, double latency, int tagCount, double tagSpan, double avgTagDist, double avgTagArea)
        {
            ...
            this.tagSpanM = tagSpan;
            this.avgTagDistM = avgTagDist;
            this.avgTagAreaPercent = avgTagArea;
        }
    }
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName)
    {
        ...
        double latencyMs = extractBotPoseEntry(poseArray, 6);
        int tagCount = (int) extractBotPoseEntry(poseArray, 7);
        double tagSpanM = extractBotPoseEntry(poseArray, 8);
        double tagDistM = extractBotPoseEntry(poseArray, 9);
        double tagAreaPercent = extractBotPoseEntry(poseArray, 10);
        // getlastchange() in microseconds, ll latency in milliseconds
        var timestampS = (poseEntry.getLastChange() / 1000000.0) - (latencyMs / 1000.0);
        return new PoseEstimate(pose, timestampS, latencyMs, tagCount, tagSpanM, tagDistM, tagAreaPercent);
    }
