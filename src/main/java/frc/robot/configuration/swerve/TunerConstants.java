package frc.robot.configuration.swerve;
...
public class TunerConstants
{
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
            .withKP(.033227).withKI(0).withKD(0)
            .withKS(0.17664).withKV(0.11064).withKA(0.019002);
    ...
    private static final double kSlipCurrentA = 250.0;
    ...
    private static final double kFrontLeftEncoderOffset = -0.345935546875;
    ...
    private static final double kFrontRightEncoderOffset = -0.385009;
    ...
    private static final double kBackLeftEncoderOffset = -0.116943359375;
    ...
    private static final SwerveModuleConstants FrontLeft = ConstantCreator.createModuleConstants(
            kFrontLeftSteerMotorId, kFrontLeftDriveMotorId, kFrontLeftEncoderId, kFrontLeftEncoderOffset, Units.inchesToMeters(kFrontLeftXPosInches),
            Units.inchesToMeters(kFrontLeftYPosInches), kInvertLeftSide);
    private static final SwerveModuleConstants FrontRight = ConstantCreator.createModuleConstants(
            kFrontRightSteerMotorId, kFrontRightDriveMotorId, kFrontRightEncoderId, kFrontRightEncoderOffset, Units.inchesToMeters(kFrontRightXPosInches),
    ...
    private static final SwerveModuleConstants BackRight = ConstantCreator.createModuleConstants(
            kBackRightSteerMotorId, kBackRightDriveMotorId, kBackRightEncoderId, kBackRightEncoderOffset, Units.inchesToMeters(kBackRightXPosInches),
            Units.inchesToMeters(kBackRightYPosInches), kInvertRightSide);

    public static SwerveDriveSubsystem getDriveTrain()
    {
