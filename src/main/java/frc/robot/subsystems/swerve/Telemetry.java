...
public class Telemetry
{
    ...
    DoubleArrayPublisher fieldPub = table.getDoubleArrayTopic("Robot").publish();
    DoubleArrayPublisher trajPub = table.getDoubleArrayTopic("traj").publish();
    ...
    public void publishPath(List<Pose2d> poses)
    {
